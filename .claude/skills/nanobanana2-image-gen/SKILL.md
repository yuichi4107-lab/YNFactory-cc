...
- **保存フォルダ名**（任意）: `03_成果物/outputs/` 配下のフォルダ名。未指定時は `nanobanana2-gen`
...
# --- 出力ディレクトリ作成 ---
output_dir = os.path.join(PROJECT_ROOT, "03_成果物", "outputs", OUTPUT_FOLDER)
...
3. アスペクト比: `1:1`（デフォルト）
4. API呼び出し → `03_成果物/outputs/nanobanana2-gen/20260324_153000_001.png` に保存
