...
last_device: "Mac（NotebookLM Sync 完了サマリ通知をエラー/新規追加時のみに変更=src/notify.py send_summary、runtime+Drive正本同期+4パターンテスト済。前回のWindowsマルチPC移行状態は last_session_summary_v2026_06_06_multipc_migration 参照）"
