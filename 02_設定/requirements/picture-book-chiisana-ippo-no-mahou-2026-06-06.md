...
Amazon KDP向けの新しい32ページ絵本『ちいさな いっぽの まほう』を制作する。
...
- タイトル: ちいさな いっぽの まほう
- サブタイトル: はじめてがこわい日に、そっと勇気を見つける絵本
- 著者名: Yuichi
- 出版社: YN出版
- 運営: YNファクトリー
- 対象年齢: 3〜5歳
- 主な購入者: 親、祖父母、入園・進級・誕生日などのギフト購入者
- テーマ: はじめての場所、はじめての挑戦、こわい気持ちを否定せず、小さな一歩で自信を育てる
- 既存絵本との差分: 『おやすみ、きょうのきもち』は寝る前の感情整理。本作は日中の挑戦・小さな勇気を扱う。
...
この要件で進めてよいか、オーナー承認待ち。

承認後、工程1から実行し、各工程で品質チェック85点以上を満たしてから次工程へ進む。
